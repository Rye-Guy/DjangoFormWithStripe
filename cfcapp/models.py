...
class SalesFormData(models.Model):
    ...
    toronto_booking = models.ForeignKey('fairs.TorontoFair', on_delete=models.SET_NULL, null=True)
    edmonton_booking = models.ForeignKey('fairs.EdmontonFair', on_delete=models.SET_NULL, null=True)
    calgary_booking = models.ForeignKey('fairs.CalgaryFair', on_delete=models.SET_NULL, null=True)
    winnipeg_booking = models.ForeignKey('fairs.WinnipegFair', on_delete=models.SET_NULL, null=True)
