    ...
    def save(self, *args, **kwargs):
        ...
        try:
            ...
            for obj in toronto_qs:
                ...
                toronto_tax_cost += obj.tax_to_charge
            ...
            for obj in calgary_qs:
                ...
                calgary_tax_cost += obj.tax_to_charge
            ...
            for obj in edmonton_qs:
                ...
                edmonton_tax_cost += obj.tax_to_charge
            ...
            for obj in winnipeg_qs:
                ...
                winnipeg_tax_cost += obj.tax_to_charge

            self.subtotal = toronto_cost + calgary_cost + edmonton_cost + winnipeg_cost
            self.total_tax_cost = toronto_tax_cost + calgary_tax_cost + edmonton_tax_cost + winnipeg_tax_cost
